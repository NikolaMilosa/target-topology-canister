  ...
  return (
    ...
    <Card className="table-card feed-card" >
      <Card.Header>
        ...
        <span>List of subnets on the IC. Links point to more information on the public dashboard.</span>
      </Card.Header>
      ...
      <Col md={12} xl={6}>
        <Card className="flat-card">
          <div className="row-table">
            ...
            <Card.Body className="col-sm-6 d-none d-md-table-cell d-lg-table-cell d-xl-table-cell  br">
                <FlatCard params={{ title: 'DC owners', iconClass: 'text-primary mb-1', icon: 'group', value: totalDataCenterProviders }} />
            </Card.Body>
          </div>
          <div className="row-table">
            <Card.Body className="col-sm-6 br">
        ...
        <Row>
          <Col md={6} sm={12}>
            <ProductCard params={{ variant: 'primary', title: 'Nodes in subnets', primaryText: `${nodesInSubnets}%`, icon: 'computer' }} />
          </Col>
          <Col md={6} sm={12}>
            <ProductCard params={{ variant: 'primary', title: 'Unassigned nodes', primaryText: `${unassignedNodes}%`, icon: 'computer' }} />
          </Col>
          <Col sm={12}>
            <ProductCard params={{ variant: 'primary', title: 'Api boundary nodes', primaryText: `${apiBns}%`, icon: 'language' }} />
          </Col>
        </Row>
          </Card.Body>
        </Card>
